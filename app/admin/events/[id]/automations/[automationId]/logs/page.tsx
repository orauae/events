...
export default function AdminExecutionLogsPage() {
    ...
    },
    {
      ...
      cell: (execution: typeof executions[0]) => {
        ...
        if (displayStatus === "Running" || displayStatus === "Waiting") {
          return <ElapsedTimeDisplay startedAt={execution.startedAt} />
        }
        return (
    ...
    },
    {
      ...
      cell: (execution: typeof executions[0]) => (
        <Button
          ...
          onClick={(e) => {
            e.stopPropagation()
            router.push(`/admin/events/${eventId}/automations/${automationId}/logs/${execution.id}`)
          }}
        >
    ...
    return (
      <div>
        <PageHeader title="Execution Logs">
          <Link href={`/admin/events/${eventId}/automations/${automationId}`}>
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                <History className="h-5 w-5 stroke-1 text-ora-gold" />
                Execution History
              </CardTitle>
              <CardDescription>
