...
export default function CampaignBuilderPage({ params }: PageProps) {
  ...
  const handleEditorError = useCallback((error: Error) => {
    console.error('[CampaignBuilderPage] Editor error:', error);
  ...
  const handleSave = useCallback(async () => {
    if (isEmail) {
      ...
      try {
        ...
        console.error('[CampaignBuilderPage] Save error:', error);
  ...
  // Parse existing design JSON if available (email only)
