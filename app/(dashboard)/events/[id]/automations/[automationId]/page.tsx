...
export default function AutomationEditorPage() {
  ...
  // Initialize nodes and edges from automation data
  useEffect(() => {
    if (automation) {
  ...
  const handleNodeSelect = useCallback((node: Node | null) => {
    ...
    // Open config sheet when a node is selected (double-click behavior handled in canvas)
    if (node) {
      ...
      <div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <Link href={`/events/${eventId}/automations`} className="mt-4 inline-block">
    ...
    <div className="-m-6 lg:-m-8 h-[calc(100vh-0px)] flex flex-col">
      ...
      <div className="flex-1 flex gap-0 overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          {/* Floating hint when node is selected */}
      ...
      <NodeConfigSheet
        ...
        onUpdate={(nodeId, data) => {
          ...
          // Update the selected node's data locally for immediate feedback
